...
Write-Host "Copying patched list.php..."
Copy-Item "$sourceDir\api\questions\list.php" "$destDir\api\questions\"

Write-Host "Done! File ready in $destDir\api\questions\list.php"
Write-Host "Please upload this file to your server's api/questions/ folder."
Write-Host "Also rebuild your frontend if you haven't already and upload that."
