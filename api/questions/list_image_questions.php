...
try {
    ...
    if ($type === 'personality') {
        $conditions[] = "question_type = 'image_identify_person'";
    } elseif ($type === 'logo') {
        $conditions[] = "question_type = 'image_identify_logo'";
    } else {
        $conditions[] = "(question_type = 'image_identify_person' OR question_type = 'image_identify_logo')";
    }
    ...
    $personalityCountSql = "SELECT COUNT(*) as count FROM questions WHERE question_type = 'image_identify_person'";
    ...
    $withImageSql = "
        ...
        FROM questions 
        WHERE (question_type = 'image_identify_person' OR question_type = 'image_identify_logo')
