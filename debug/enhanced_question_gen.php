...
You must respond with ONLY a JSON array (no markdown, no code blocks, no explanation).

Each object in the array must have exactly these fields:
- text: The question text (string)
- options: Array of exactly 4 strings (the answer choices)
- correct_answer: The correct option string (must exactly match one of the options)
- explanation: Brief explanation of why the answer is correct (string)
- category: The category/topic (string, use '$topic')
- type: The question type (string, use '$type')
