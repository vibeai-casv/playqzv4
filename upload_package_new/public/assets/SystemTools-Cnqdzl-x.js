import{j as e}from"./index-CtFufLgh.js";import{r as c}from"./vendor-D8AvkUoV.js";import{a9 as m,P as p,T as g,g as r,aa as x}from"./ui-CX4g-7i5.js";const b=async i=>(i("Seeder is currently disabled during migration to MySQL."),{successCount:0,failCount:0,skippedCount:0});function N(){const[i,o]=c.useState(!1),[l,n]=c.useState([]),a=s=>{n(t=>[...t,`[${new Date().toLocaleTimeString()}] ${s}`])},u=async()=>{if(confirm("This will insert questions from the local JSON files into the database. Continue?")){o(!0),n([]),a("Starting seed process...");try{const s=await b(t=>a(t));a(`Completed! Success: ${s.successCount}, Skipped: ${s.skippedCount}, Failed: ${s.failCount}`),r.success(`Seeding complete! Added ${s.successCount} questions.`)}catch(s){a(`Error: ${s.message}`),r.error("Seeding failed")}finally{o(!1)}}},d=`
